        ...
        <div class="invoices">
            ...
            <div class="card__content">
                <div class="card__content--header">
                    <div>
                        ...
                        <select v-model="form.customer_id" name="" id="" class="input">
                            ...
                            <option :value="customer.id" v-for="customer in allCustomers" :key="form.customer_id">
                                {{ customer.firstname }}
                            </option>
                        </select>
                    </div>
                ...
                <div class="table">
                    ...
                    <!-- item 1 -->
                    <div v-for="(itemCard, i) in form.invoice_items" :key="itemCard.id" class="table--items2">
                        <p v-if="itemCard.product">#{{ itemCard.product.item_code }} {{ itemCard.product.description }}</p>
                        <p v-else>
                        ...
                        <p @click="deleteInvoiceItem(itemCard.id, i)" style="color: red; font-size: 24px;cursor: pointer;">
                            &times;
                        </p>
                    </div>
